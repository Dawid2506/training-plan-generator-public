  ...
  return (
    <tr
      ...
      className={cn(
        ...
        "hover:bg-surface-muted/60 data-[state=selected]:bg-primary/8",
        className,
      )}
      {...props}
    />
...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-10 px-3 text-left align-middle text-[11px] font-medium tracking-[0.06em] text-muted-foreground uppercase whitespace-nowrap",
